...
Console.WriteLine("This app will let you convert between a Base 10 or Base 2 file size, for example from Terrabyte (TB) to Tebibyte (TiB).\nUse the numbers inside the brackets [ ] to choose the option you want.");
do
{
    string choiceValue = "";
    ...
    while (true)
    {
        ...
        Console.WriteLine("Input was not valid, please enter a valid float number (such as 9,821 etc.)");
        continue;
